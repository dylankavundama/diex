    ...
    <div class="admin-layout">
        ...
        <aside class="admin-sidebar" id="adminSidebar">
            ...
            <nav class="admin-menu">
                ...
                <a href="create_sale.php" class="admin-menu-item <?php echo $active_page === 'create_sale.php' ? 'active' : ''; ?>">
                    <i class="fas fa-cash-register"></i> Effectuer une vente
                </a>
                ...
                <a href="cash.php" class="admin-menu-item <?php echo $active_page === 'cash.php' ? 'active' : ''; ?>">
                    <i class="fas fa-wallet"></i> Caisse
                </a>
